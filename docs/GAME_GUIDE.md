...
- 목표 거점: 중립 거점 `A / B / C`
- 시작 병력: 진영별 10기
- 초기 편성: 보병 4기, 전차 2기, 드론 2기, 헬기 1기, 전투기 1기
...
전투기를 직접 조종할 때 `Space`는 기수를 위로, `Shift`는 아래로 계속 회전시킵니다. 충분한 고도에서 `Space`를 약 8초간 유지하면 상승·배면·하강 구간이 연결된 360° 후방 루프를 완주합니다. 기본 3인칭 카메라는 기체를 중앙에 두고 지평선과 지면을 계속 보여주며, `V`로 전환하는 1인칭은 기수 방향을 그대로 따라갑니다.
