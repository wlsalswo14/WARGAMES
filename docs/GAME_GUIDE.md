...
플레이어는 피해를 받지 않는 전장 지휘관으로 시작합니다. 높은 시점에서 전황을 읽고 병력에 명령을 내리다가, 전차·보병·드론 등 아군 유닛 하나에 즉시 접속해 직접 전투할 수 있습니다.
...
4. `W / A / S / D`로 이동하고 좌클릭으로 일반공격합니다.
...
| 입력 | 기능 |
| --- | --- |
| 마우스 이동 | 상하·좌우 전체 반전 조준과 시점 회전 |
| `W / S` | 전진 / 후진 |
| `A / D` | 오른쪽 / 왼쪽 이동 |
| `Space / Shift` | 항공 유닛 상승 / 하강 |
| 좌클릭 | 빠른 일반공격 |
| 우클릭 | 강력한 특수공격 또는 드론 자폭 |
| `V` | 1인칭 / 3인칭 전환 |
| `G / Esc` | God Mode 복귀 |
...
전투기와 헬기는 Sandbox에서 사용할 수 있습니다. 두 유닛 모두 일반공격과 전차 주포급 특수공격을 보유하며, 지형·나무·건물·거점·적 유닛에 충돌하면 파괴됩니다. 아군 공중 유닛끼리의 충돌은 무시합니다.
