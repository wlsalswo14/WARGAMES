...
const CHALLENGE_THEME: BattlefieldTheme = {
  ...
  terrainStamps: [
    ...
    { kind: 'trench', x: -52, z: -88 },
    { kind: 'trench', x: 52, z: -88 },
    { kind: 'trench', x: -48, z: 0 },
    { kind: 'trench', x: 48, z: 0 },
    { kind: 'trench', x: -52, z: 88 },
    { kind: 'trench', x: 52, z: 88 },
  ],
...
const RIDGE_THEME: BattlefieldTheme = {
  ...
  terrainStamps: [
    ...
    { kind: 'trench', x: -62, z: -92 },
    { kind: 'trench', x: 34, z: -48 },
    { kind: 'trench', x: -34, z: 48 },
    { kind: 'trench', x: 62, z: 92 },
  ],
  buildings: [],
...
const TRENCH_THEME: BattlefieldTheme = {
  ...
  treeDensity: 0.08,
  terrainStamps: [
    { kind: 'trench', x: -60, z: -82 },
    { kind: 'trench', x: -30, z: -82 },
    { kind: 'trench', x: 0, z: -82 },
    { kind: 'trench', x: 30, z: -82 },
    { kind: 'trench', x: 60, z: -82 },
    { kind: 'trench', x: -60, z: 0 },
    { kind: 'trench', x: -30, z: 0 },
    { kind: 'trench', x: 0, z: 0 },
    { kind: 'trench', x: 30, z: 0 },
    { kind: 'trench', x: 60, z: 0 },
    { kind: 'trench', x: -60, z: 82 },
...
const TRENCH_STRUCTURES: StructurePlan[] = [
  ...
  wall('trench-azure-cover', -116, 0, 30, 6, Math.PI / 2, 0x315e9b, 'azure'),
  wall('trench-crimson-cover', 116, 0, 30, 6, Math.PI / 2, 0x8f343c, 'crimson'),
];
